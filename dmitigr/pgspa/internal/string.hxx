...
#ifndef DMITIGR_PGSPA_INTERNAL_STRING_HXX
#define DMITIGR_PGSPA_INTERNAL_STRING_HXX
...
namespace dmitigr::pgspa::internal::string {
...
{
  DMITIGR_PGSPA_INTERNAL_ASSERT(2 <= base && base <= 36);
...
#endif  // DMITIGR_PGSPA_INTERNAL_STRING_HXX
